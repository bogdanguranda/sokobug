...
public class Pad {
	...
	public MoveDirection arrowDirectionByPoint(float pointX, float pointY) {
		...
		Rectangle rightArrow = new Rectangle(padSprite.getX() + widthOneThird * 2.f, padSprite.getY() + heightOneThird,
				widthOneThird, heightOneThird);
		Rectangle downArrow = new Rectangle(padSprite.getX() + widthOneThird, padSprite.getY(), widthOneThird,
				heightOneThird);
		Rectangle leftArrow = new Rectangle(padSprite.getX(), padSprite.getY() + heightOneThird, widthOneThird,
				heightOneThird);
